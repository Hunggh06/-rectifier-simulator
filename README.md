...
1. **Bộ dữ liệu 19 mạch / 93 bản ghi**:
   - **Chương 2 (Chỉnh lưu)**: 1P nửa chu kỳ (Diode, Thyristor), 1P tia 2 nửa (Diode, Thyristor), 1P cầu (Diode, Thyristor, Bán ĐK), 3P tia (Diode, Thyristor), 3P cầu (Diode, Thyristor, Bán ĐK, Kích sai thứ tự).
